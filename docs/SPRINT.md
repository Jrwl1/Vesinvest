...
- [x] Rebuild the forecast landing hierarchy into the chosen Signal Grid scenario cockpit with one dominant financial story
  ...
  - evidence: row:d0345e2 | run:pnpm --filter ./apps/web test -- src/v2/EnnustePageV2.test.tsx src/i18n/locales/localeIntegrity.test.ts && pnpm --filter ./apps/web typecheck -> pass | files:apps/web/src/v2/EnnustePageV2.test.tsx, apps/web/src/v2/EnnustePageV2.tsx, apps/web/src/v2/v2.css | docs:N/A | status: clean

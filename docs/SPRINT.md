...
- [x] Replace the generic chosen-year correction sentence with a short exact edited-line label
  ...
  - evidence: row:532c2d441d3f46ec1f70f3c5887f7d42c80c64b0 | run:pnpm --filter ./apps/web test -- src/v2/OverviewPageV2.test.tsx src/i18n/locales/localeIntegrity.test.ts && pnpm --filter ./apps/web typecheck -> PASS | files:apps/web/src/i18n/locales/en.json, apps/web/src/i18n/locales/fi.json, apps/web/src/i18n/locales/sv.json, apps/web/src/v2/OverviewPageV2.test.tsx, apps/web/src/v2/useOverviewSetupState.ts | docs:N/A | status: clean

- [x] Keep the wording short and factual by listing only the edited line name(s)

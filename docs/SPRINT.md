...
| S-106 | Close with focused regressions and a live Kronoby audit. See S-106 substeps. | apps/web/src/v2/OverviewPageV2.test.tsx, apps/web/src/v2/yearReview.test.ts, apps/web/src/v2/EnnustePageV2.test.tsx, apps/web/src/i18n/locales/localeIntegrity.test.ts, apps/api/src/v2/v2.service.spec.ts, docs/EXCEL_OVERRIDE_AND_INVESTMENT_AUDIT.md | Focused regressions pass, a wiped-workspace live audit covers Kronoby wipe, VEETI reconnect/import, workbook compare/apply, 2024 statement merge, and entry into `Investointiohjelma`, and the audit artifact ends with `whole sprint succeeded` or a blocker. | Packet `bd3c727032726be059c540720fb380f41c5962bc` passed the final regression suite; live audit artifact `e047e27` recorded a blocker on the unproven 2024 statement merge path. | Stop if the available customer docs still leave one required source mapping untruthful in the live flow; record the blocker in the audit artifact and stop there. | IN_PROGRESS |
...
- [ ] Run a wiped-workspace live audit for Kronoby covering wipe, reconnect/import, workbook repair, 2024 statement merge, and entry into `Investointiohjelma`
  ...
  - evidence: HARD BLOCKED: live audit reached wipe, reconnect/import, workbook compare/apply, and entry into `Investointiohjelma`, but 2024 statement-PDF + workbook mixed ownership remained unproven in the live path; see docs/EXCEL_OVERRIDE_AND_INVESTMENT_AUDIT.md (packet:e047e27dc54ec42dcb0a5e7b0428d77978ea22f3)

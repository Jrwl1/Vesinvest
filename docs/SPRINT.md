...
- [ ] Add wizard key families to the hard locale parity list so missing wizard keys fail tests
  ...
  - evidence: BLOCKED: localeIntegrity test fails on mojibake in out-of-scope apps/web/src/v2/OverviewPageV2.tsx

...
5. The security/performance remediation queue `S-149..S-155` is accepted, while `S-156` remains a deployment-only header-verification hold that cannot be closed from this workspace; the frontend trust/interaction and login/year-card follow-up rows `S-157..S-168` are accepted history, and the current locally executable target in `docs/SPRINT.md` is the V2 shell header cleanup plus chosen-year manual-edit truth queue `S-169..S-170`.

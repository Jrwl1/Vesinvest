...
| S-120 | Close with focused regressions and a full CFO reset-to-PDF live audit. See S-120 substeps. | apps/web/src/v2/**, apps/api/src/v2/**, apps/api/src/projections/**, docs/CFO_END_TO_END_AUDIT_2026-03-19.md | A fresh reset -> connect -> import -> review -> baseline -> forecast -> report audit proves a CFO can use the product end to end without an obvious trust, hierarchy, or localization blocker, or records the blocker precisely. | Packets `b194f233511592123edc93fabb61c05c4834473b` and `5bf0c0fadd7015c25bc75ad26f0e10d6a08b217f` landed; review pending. | Stop if a fresh live audit still exposes a trust gap that the current queue does not cover; record the blocker and stop there. | READY |

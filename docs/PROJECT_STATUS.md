...
- Sprint **S-20 is in progress** (substeps 1-2 complete: merge-safe update paths + backward/forward compatibility tests for year-overrides/scenario contracts).
...
1. Execute `S-20` substep 3 (extend E2E flow coverage for delete->sync persistence, 5-year+thereafter, zero-result mode, and depreciation rules).

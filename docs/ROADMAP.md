...
5. The security/performance remediation queue `S-149..S-155` is accepted, while `S-156` remains a deployment-only header-verification hold that cannot be closed from this workspace; the frontend trust/interaction and login/year-card follow-up rows `S-157..S-170` are accepted history, and the current locally executable target in `docs/SPRINT.md` is the live dev-site cleanup queue `S-171..S-175` for step-2 through step-4 copy, action hierarchy, provenance, and prefetch truth.

...
3. `S-23` is now the next active delivery row and still needs structured 20-year investment persistence plus compatibility coverage.

## Next 5 actions

1. Continue `S-23` structured 20-year investment model work in Forecast.
2. Continue `S-24` fee sufficiency and stress-risk outputs on top of effective baseline data.
3. Finish `S-25` public/confidential variants and end-to-end regression proof.
4. Keep customer TBDs `B-TBD-01..B-TBD-05` tracked as non-blocking.
5. Preserve the new statement-import and year-review flow while Forecast and Reports continue to evolve.

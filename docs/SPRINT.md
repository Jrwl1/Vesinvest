...
| S-159 | Simplify the step-2 import board hierarchy, chronology, and parked-year treatment. See S-159 substeps. | apps/web/src/v2/OverviewImportBoard.tsx, apps/web/src/v2/useOverviewSetupState.ts, apps/web/src/v2/overviewLabels.ts, apps/web/src/v2/v2.css, apps/web/src/v2/OverviewPageV2.test.tsx, apps/web/src/i18n/locales/*.json | Visible year cards read chronologically left-to-right inside each lane, the missing-data warning stays primary, `Sekundära huvudtal` is replaced with plain pricing/volume language, and parked/unselected years move behind a secondary disclosure that still scales when five or more good VEETI years are present. | row:f20169fa4c1472ec734141209a8e45c660c400d4 \| run:pnpm --filter ./apps/web test -- src/v2/OverviewPageV2.test.tsx src/i18n/locales/localeIntegrity.test.ts; pnpm --filter ./apps/web typecheck -> PASS \| files:apps/web/src/v2/OverviewPageV2.test.tsx \| docs:N/A \| status: clean | Stop if collapsing parked years or reordering cards breaks current imported-year state truth or makes five-year selection less recoverable than today. | DONE |
| S-160 | Repair step-2 inline row editing so it behaves like a local card correction flow, not a sticky slab. See S-160 substeps. | apps/web/src/v2/OverviewImportBoard.tsx, apps/web/src/v2/OverviewPageV2.tsx, apps/web/src/v2/useOverviewManualPatchEditor.ts, apps/web/src/v2/v2.css, apps/web/src/v2/OverviewPageV2.test.tsx | The full finance row is clickable for edit, save closes the step-2 editor, and after saving one card the user can reopen the same or another year normally without relying on tiny value-chip targets. | row:196b78760317a18bab241753ed71df39db1d034e \| run:pnpm --filter ./apps/web test -- src/v2/OverviewPageV2.test.tsx; pnpm --filter ./apps/web typecheck -> PASS \| files:apps/web/src/v2/OverviewPageV2.test.tsx \| docs:N/A \| status: clean | Stop if whole-row click or close-on-save behavior would require a broader draft-state model or would collapse current checkbox/action affordances into one ambiguous control surface. | DONE |
| S-161 | Make the result warning/signal truthful and understandable after inline financial edits. See S-161 substeps. | apps/web/src/v2/yearReview.ts, apps/web/src/v2/overviewManualForms.ts, apps/web/src/v2/OverviewImportBoard.tsx, apps/web/src/v2/OverviewPageV2.tsx, apps/web/src/i18n/locales/*.json, apps/web/src/v2/**/*.test.ts, apps/web/src/v2/**/*.test.tsx, apps/api/src/v2/v2.service.ts, apps/api/src/v2/dto/manual-year-completion.dto.ts, apps/api/src/v2/**/*.spec.ts | The visible result row and its warning text stay coherent after inline finance edits, `/ 0` jargon is removed, and if `TilikaudenYliJaama` remains a separately stored field the UI makes that truth explicit instead of implying silent derivation. | row:8a05192a4dae27fc05107784485cfd9fcade7918 \| run:pnpm --filter ./apps/web test -- src/v2/yearReview.test.ts src/v2/OverviewPageV2.test.tsx src/i18n/locales/localeIntegrity.test.ts; pnpm --filter ./apps/api test -- src/v2/v2.service.spec.ts; pnpm --filter ./apps/web typecheck; pnpm --filter ./apps/api typecheck -> PASS \| files:apps/web/src/v2/yearReview.test.ts, apps/api/src/v2/v2.service.spec.ts \| docs:N/A \| status: clean | Stop if truthful result behavior requires a broader accounting-contract decision than the current manual-year patch seam can safely absorb. | DONE |
| S-162 | Close with focused wizard regressions and a connected-workspace re-audit that includes a five-year import case. See S-162 substeps. | apps/web/src/**, apps/api/src/v2/**, apps/api/src/veeti/**, apps/web/src/**/*.test.tsx, apps/api/src/**/*.spec.ts, docs/SETUP_WIZARD_UIUX_REAUDIT.md | Focused regressions plus a fresh connected-workspace live audit prove the login cleanup, VEETI search stabilization, support rail, chronological five-year board, parked-year disclosure, row-edit/save behavior, and result warning changes work without a new trust blocker, or record the blocker precisely. | row:b17a1d9d1518fd46b27f988e117ca71a2e0779a3 \| run:pnpm --filter ./apps/web test -- src/App.test.tsx src/components/LoginForm.test.tsx src/v2/AppShellV2.test.tsx src/v2/OverviewPageV2.test.tsx src/v2/yearReview.test.ts src/i18n/locales/localeIntegrity.test.ts; pnpm --filter ./apps/api test -- src/v2/v2.service.spec.ts; pnpm --filter ./apps/web typecheck; pnpm --filter ./apps/api typecheck -> PASS \| files:docs/SETUP_WIZARD_UIUX_REAUDIT.md \| docs:N/A \| status: clean | Stop if the re-audit still exposes a new trust or workflow gap outside `S-157..S-161`; record the blocker and stop there. | READY |
| S-163 | Correct the login-entry language contract and selector behavior. See S-163 substeps. | apps/web/src/components/LoginForm.tsx, apps/web/src/components/LanguageSwitcher.tsx, apps/web/src/i18n/index.ts, apps/web/src/i18n/locales/*.json, apps/web/src/App.css, apps/web/src/components/*.test.tsx, apps/web/src/App.test.tsx | On first unauthenticated open the login screen starts in Finnish, the existing in-app language selector is visible on the login screen, and the FI/SV/EN login copy uses one plain product/task meaning without workflow-jargon like imported/reviewed years or planning baseline. | row:8d3ba0f806a12b1f03fcc3b3d4699aee340185f4 \| run:pnpm --filter ./apps/web test -- src/App.test.tsx src/components/LoginForm.test.tsx src/components/LanguageSwitcher.test.tsx src/i18n/locales/localeIntegrity.test.ts; pnpm --filter ./apps/web typecheck -> PASS \| files:apps/web/src/i18n/locales/localeIntegrity.test.ts \| docs:N/A \| status: clean | Stop if Finnish-first unauthenticated entry conflicts with a customer-locked language-selection rule outside current repo evidence. | DONE |
...
- [x] Render step-2 year cards chronologically within each lane and keep five-year import cases readable without newest-to-oldest reading order
  ...
  - evidence: row:f20169fa4c1472ec734141209a8e45c660c400d4 | run:pnpm --filter ./apps/web test -- src/v2/OverviewPageV2.test.tsx src/i18n/locales/localeIntegrity.test.ts; pnpm --filter ./apps/web typecheck -> PASS | files:apps/web/src/v2/OverviewPageV2.test.tsx | docs:N/A | status: clean
...
- [x] Make the full step-2 finance row clickable for inline edit instead of limiting entry to the numeric value button
  ...
  - run: pnpm --filter ./apps/web test -- src/v2/OverviewPageV2.test.tsx && pnpm --filter ./apps/web typecheck
  - evidence: row:196b78760317a18bab241753ed71df39db1d034e | run:pnpm --filter ./apps/web test -- src/v2/OverviewPageV2.test.tsx; pnpm --filter ./apps/web typecheck -> PASS | files:apps/web/src/v2/OverviewPageV2.test.tsx | docs:N/A | status: clean
...
- [x] Replace `/ 0` result jargon with plain warning copy and keep the visible result signal coherent after inline financial edits
  ...
  - evidence: row:8a05192a4dae27fc05107784485cfd9fcade7918 | run:pnpm --filter ./apps/web test -- src/v2/yearReview.test.ts src/v2/OverviewPageV2.test.tsx src/i18n/locales/localeIntegrity.test.ts; pnpm --filter ./apps/web typecheck -> PASS | files:apps/web/src/v2/yearReview.test.ts, apps/api/src/v2/v2.service.spec.ts | docs:N/A | status: clean
...
- [x] If `TilikaudenYliJaama` remains a separately stored field, make that truth explicit across summary/build warning paths and cover it with web/api regression proof
  ...
  - evidence: row:8a05192a4dae27fc05107784485cfd9fcade7918 | run:pnpm --filter ./apps/web test -- src/v2/yearReview.test.ts src/v2/OverviewPageV2.test.tsx; pnpm --filter ./apps/api test -- src/v2/v2.service.spec.ts; pnpm --filter ./apps/web typecheck; pnpm --filter ./apps/api typecheck -> PASS | files:apps/web/src/v2/yearReview.test.ts, apps/api/src/v2/v2.service.spec.ts | docs:N/A | status: clean
...
- [x] Run the focused login + wizard regression bundle for the new entry copy, support rail, chronology, parked-year, search, and row-edit behavior
  ...
  - evidence: row:3fb81c0699f2389b3091b236f66446e83ba4cb91 | run:pnpm --filter ./apps/web test -- src/App.test.tsx src/components/LoginForm.test.tsx src/v2/AppShellV2.test.tsx src/v2/OverviewPageV2.test.tsx src/v2/yearReview.test.ts src/i18n/locales/localeIntegrity.test.ts; pnpm --filter ./apps/api test -- src/v2/v2.service.spec.ts; pnpm --filter ./apps/web typecheck; pnpm --filter ./apps/api typecheck -> PASS | files:docs/SETUP_WIZARD_UIUX_REAUDIT.md | docs:N/A | status: clean
...
- [x] Re-run a connected-workspace live audit through VEETI connect, year import, five-year selection/recovery, row edit/save, and baseline context, and record whether the queue succeeded or stopped on a blocker in `docs/SETUP_WIZARD_UIUX_REAUDIT.md`
  ...
  - evidence: row:b17a1d9d1518fd46b27f988e117ca71a2e0779a3 | run:N/A (manual browser audit allowed) -> PASS | files:docs/SETUP_WIZARD_UIUX_REAUDIT.md | docs:N/A | status: clean
...
- [x] Force unauthenticated app entry to Finnish by default until the user explicitly switches language
  ...
  - evidence: row:8d3ba0f806a12b1f03fcc3b3d4699aee340185f4 | run:pnpm --filter ./apps/web test -- src/App.test.tsx src/components/LoginForm.test.tsx; pnpm --filter ./apps/web typecheck -> PASS | files:apps/web/src/i18n/locales/localeIntegrity.test.ts | docs:N/A | status: clean
...
- [x] Add the existing in-app language selector to the login screen and replace FI/SV/EN login copy with one plain Finnish source meaning translated cleanly across all three locales
  ...
  - evidence: row:8d3ba0f806a12b1f03fcc3b3d4699aee340185f4 | run:pnpm --filter ./apps/web test -- src/components/LoginForm.test.tsx src/components/LanguageSwitcher.test.tsx src/i18n/locales/localeIntegrity.test.ts; pnpm --filter ./apps/web typecheck -> PASS | files:apps/web/src/i18n/locales/localeIntegrity.test.ts | docs:N/A | status: clean

...
| S-05 | Phase E â€” Extract EnnusteScenarioRow, EnnusteSyotaZone, EnnusteTuloksetZone; add Suspense/skeletons for chart and table; final substep = perfectly working site as planned. See S-05 substeps below. | apps/web/src/pages/ProjectionPage.tsx, apps/web/src/components/* (new or existing) | Extracted components; Suspense boundaries; full flow works; lint/typecheck/test pass; site matches plan. | c4aded3, f8f467b, 92fb8b3 | Stop if extraction breaks state or tests. | READY |

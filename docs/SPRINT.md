...
| S-65 | Split ready-year review mode from problem-year edit mode and make the language truthful. See S-65 substeps. | apps/web/src/v2/OverviewPageV2.tsx, apps/web/src/v2/v2.css, apps/web/src/i18n/locales/en.json, apps/web/src/i18n/locales/fi.json, apps/web/src/i18n/locales/sv.json, apps/web/src/v2/OverviewPageV2.test.tsx | Technically ready years use review/approval language instead of problem-year language, the detail surface opens in review mode first, and editable inputs are shown only after the user explicitly chooses to edit. | Ready for review: packet `79116e9fd5a079f4d5f4d93688ada44f6cd4c2d8`; see substep evidence. | Stop if the current shared detail surface cannot support explicit review-versus-edit mode without a broader component split than this queue allows. | READY |

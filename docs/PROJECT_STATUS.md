...
- Sprint **S-19 is in progress** (substeps 1-4 complete: schema+migration + CRUD/allocation paths + engine cohort schedule + Forecast UI wiring).
...
1. Execute `S-19` substep 5 (fallback compatibility tests for scenarios without configured depreciation rules).

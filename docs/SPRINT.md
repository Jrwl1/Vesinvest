...
| S-92 | Close with a full `Yhteenveto` audit against the locked plan and the real 2024 PDF path. See S-92 substeps. | apps/web/src/v2/OverviewPageV2.test.tsx, apps/web/src/v2/yearReview.test.ts, apps/web/src/v2/statementOcr.test.ts, apps/web/src/i18n/locales/localeIntegrity.test.ts, apps/api/src/v2/v2.service.spec.ts, apps/api/src/veeti/veeti-budget-generator.spec.ts, docs/YHTEENVETO_FINAL_AUDIT.md | Focused regressions pass, a wiped-workspace live audit proves the step-2 and step-3 cards follow the 6-row canon, the real 2024 PDF still corrects the year in-card, the audit explicitly records the subrow-availability answer, and the artifact ends with `whole sprint succeeded` or a blocker. | Packet `d6c782887b68ffc18c72c0e2c9bd4c3bd00f9bfe` locked the final regression suite; live audit artifact packet still pending. | Stop if the final audit still finds a card-structure, wording, editing-surface, language, or PDF-correction blocker after `S-87..S-91`; record it and stop there. | IN_PROGRESS |

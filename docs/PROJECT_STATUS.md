...
- `S-29` is `IN_PROGRESS`: shared V2 spacing, chrome, shell navigation/drawer behavior, and badge semantics are now aligned; copy tone and responsive cleanup remain.

...
- [x] Restrict linked-workspace year-detail prefetch to imported or review-visible years for the active step
  ...
  - evidence: packet:b8d911edffb211b2e726793ed82a1ff6588275e5 | run:pnpm --filter ./apps/web test -- src/v2/OverviewPageV2.test.tsx src/v2/AppShellV2.test.tsx && pnpm --filter ./apps/web typecheck -> PASS | files:apps/web/src/v2/OverviewPageV2.tsx | docs:N/A | status: clean

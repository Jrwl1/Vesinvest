...
3. Sprint and backlog formats are executable, evidence-driven, and active-only in their main files, with accepted history moved to archive docs instead of being kept inline.
